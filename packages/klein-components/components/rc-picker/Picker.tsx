...
import type { AlignType } from '../rc-trigger/interface';
...
export type PickerColDateProps<DateType> = {
  picker: 'colDate';
  /**
   * @deprecated Please use `defaultValue` directly instead
   * since `defaultOpenValue` will confuse user of current value status
  ...
  Omit<OmitPanelProps<PickerPanelColDateProps<DateType>>, 'format'>;
  ...
  return (
    <PanelContext.Provider
      value={{
        ...
        hideHeader: picker === 'time' || picker === 'colDate', // szp
