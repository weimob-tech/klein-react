...
import { ASSET_FIGMA, ASSET_FONT, ASSET_ICON } from '@/constant'
    ...
    return (
      <div className='klein-resource-item'>
        ...
        <div className='klein-resource-item-content'>
          <div className='klein-resource-item-title'>{item.title}</div>
          <div className='klein-resource-item-desc'>{item.desc}</div>
        </div>
        <div className='klein-resource-item-download'>
          {item.link ? (
            <a href={item.link} download={item.link}>
