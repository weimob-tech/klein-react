...
export default function useCellClassName<DateType>({
  ...
  curMonth?: NullableDateType<DateType>;
  curYear?: NullableDateType<DateType>;
  curQuarter?: NullableDateType<DateType>;
  ...
  function getClassName(currentDate: DateType) {
    ...
    return {
      ...
      [`${cellPrefixCls}-current-month`]: isSameCell(curMonth, currentDate),
      [`${cellPrefixCls}-current-year`]: isSameCell(curYear, currentDate),
      [`${cellPrefixCls}-current-quarter`]: isSameCell(curQuarter, currentDate),
