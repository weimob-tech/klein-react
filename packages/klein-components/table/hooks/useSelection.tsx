...
import DownOutlined from '../../components/svg-components/DownLine';
import { convertDataToEntities } from '../../components/rc-tree/utils/treeUtil';
import { conductCheck } from '../../components/rc-tree/utils/conductUtil';
import { arrAdd, arrDel } from '../../components/rc-tree/util';
import type {
  DataNode,
  GetCheckDisabled,
} from '../../components/rc-tree/interface';
import { INTERNAL_COL_DEFINE } from '../../components/rc-table';
import type { FixedType } from '../../components/rc-table/interface';
  ...
  const transformColumns = useCallback(
    (columns: ColumnsType<RecordType>): ColumnsType<RecordType> => {
      ...
      if (selectionType !== 'radio') {
        ...
        title = !hideSelectAll && (
          <div className={`${prefixCls}-selection`}>
            <Checkbox
              checked={
                !allDisabled && !!flattedData.length && checkedCurrentAll
              }
      ...
      if (expandType === 'row' && columns.length && !expandIconColumnIndex) {
        ...
        return [
          expandColumn,
          { ...selectionColumn, fixed: selectionFixed },
          ...restColumns,
        ];
      }
      return [
        { ...selectionColumn, fixed: fixed || getFixedType(columns[0]) },
        ...columns,
      ];
    },
    [
