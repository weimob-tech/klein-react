...
const Slider = React.forwardRef(
  (props: SliderProps, ref: React.Ref<SliderRef>) => {
    ...
    // ============================= Step =============================
    const mergedStep = React.useMemo(
      () => (step !== null && step <= 0 ? 1 : step),
      [step],
    );
    ...
    // ============================ Values ============================
    const [mergedValue, setValue] = useMergedState<number | number[], number[]>(
      defaultValue,
      {
        value,
      },
    ...
    const rawValues = React.useMemo(() => {
      ...
      if (range) {
        ...
        if (count || mergedValue === undefined) {
          const pointCount = (count as number) >= 0 ? (count as number) + 1 : 2;
