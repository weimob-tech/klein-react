...
import CaretDownOutlined from '../../components/svg-components/ArrowDownFill';
import CaretUpOutlined from '../../components/svg-components/ArrowUpFill';
import type {
  TransformColumns,
  ColumnsType,
  Key,
...
function injectSorter<RecordType>(
  ...
  triggerSorter: (sorterSates1: SortState<RecordType>) => void,
